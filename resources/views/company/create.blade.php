        ...
        <div class="sideapp">
            ...
            <div class="page-header mt-0 mb-0">
                <ol class="breadcrumb"><!-- breadcrumb -->
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Add Company') }}</li>
                </ol><!-- End breadcrumb -->
            </div>
            <!-- End page-header -->
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0 card-title">{{ __('Add Company') }}</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone" placeholder="Enter Company Phone">
                                        </div>
                                    </div>
                                </div>
